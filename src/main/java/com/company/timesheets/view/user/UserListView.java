...
public class UserListView extends StandardListView<User> {
    ...
    BackgroundTask<Integer, Void> task = new EmailTask(title, body, users);
        ...
        BackgroundTaskHandler<Void> handler1 = backgroundWorker.handle(task);
        BackgroundTaskHandler<Void> handler2 = backgroundWorker.handle(task);
...
//            .open();
    ...
    private class EmailTask extends BackgroundTask<Integer, Void> {
        ...
        public void done(Void result) {
            notifications.create("Email(s) has been sent!")
